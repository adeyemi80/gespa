...
<h2>
Classement des CANDIDATS à l'Examen Blanc de - {{ $examen->type }}<br>
...
Plus Faible Moyenne : {{ number_format($stats['min'],2) }}, Plus Forte Moyenne : {{ number_format($stats['max'],2) }}<br>
