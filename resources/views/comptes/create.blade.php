        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-gradient text-white rounded-top-4"
                    ...
                    <h3 class="mb-0"><i class="bi bi-plus-circle me-2"></i> Nouveau Compte</h3>
                </div>
                    ...
                    <form action="{{ route('comptes.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" id="type" class="form-select shadow-sm @error('type') is-invalid @enderror" required>
                                ...
                                <option value="Mobile Money" {{ old('type')=='Mobile Money'?'selected':'' }}>Mobile Money</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control shadow-sm @error('solde_initial') is-invalid @enderror" 
                                   id="solde_initial" name="solde_initial" value="{{ old('solde_initial') }}" required>
