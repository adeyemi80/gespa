        ...
        <div class="row card text-white bg-dark">
            ...
            <div class="card-body">
                <form action="{{ url('contact.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                      <input type="numeric" class="form-control  @error('telephone') is-invalid @enderror" name="telephone" id="telephone" placeholder="Votre numero de Téléphone" value="{{ old('telephone') }}">
                      @error('objet')
                          <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control  @error('objet') is-invalid @enderror" name="objet" id="objet" placeholder="Votre Objet" value="{{ old('objet') }}">
                    @error('objet')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
