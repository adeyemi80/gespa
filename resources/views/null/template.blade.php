...
<head>
    ...
    <style>
        ...
        .bande-lumi {
            background: skyblue; /*red;  blue; green; darkorange; lightgray;  */
            padding: 3px;
            text-align: center;
            font-size: 16px;
            font-weight: bold;
        ...
        th, td { border: 1px solid #000; padding: 4px 3px; text-align: center; font-size: 10px; height: 20px; line-height: 16px; }
    ...
    <tr>
       <th>Plus faible Moyenne</th><td>{{ $plusFaibleMoyenne ?? 'N/A'  }}</td>
         <th>Plus forte Moyenne</th><td>{{ $plusForteMoyenne ?? 'N/A'  }}</td>
          <th> Rang Trimestre  </th>{{ $moyenne->rang_trimestre ?? 'N/A'  }}<td>
...
<table class="table">
    <tr>
        <th>Moyenne Premier Trimestre</th><td></td>
        <th>Moyenne Deuxième Trimestre</th><td></td>
        <th>Moyenne Troisième Trimestre</th><td> </td>
    </tr>
    <tr>
        <th>Moyenne Annuelle</th><td></td>
        <th>Rang Annuel</th><td>{{ $rang_annuel ?? 'N/A' }}</td>
         <th>Appréciation</th><td></td>
    </tr>
</table>
<!-- Signatures -->
...
@endif
        ...
        <td>
            <img src="file://{{ public_path('images/cache.png') }}" width="200" height="120" alt="Cachet">
        </td>
    </tr>
</table>
