    ...
    <header class="text-dark">
        <div class="container-fluid d-flex justify-content-between align-items-center h-100 px-5">
            ...
            <div class="d-flex align-items-center gap-4">
                <a class="header-btn glass-effect" href="tel:+2290197189324" title="Appeler">
                    <i class="fas fa-phone fs-4"></i>
                    <span class="d-none d-xl-inline ms-2 fw-semibold">+229 01 97 18 93 24 / +229 01 97 52 16 37</span>
                </a>
                <a class="header-btn glass-effect" href="mailto:complexeleglorieux@gmail.com" title="Email">
                ...
                @auth
                <div class="dropdown">
                    <a class="header-btn glass-effect d-flex align-items-center gap-3 p-3" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
