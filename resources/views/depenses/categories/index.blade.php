...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('categories-depenses.create') }}" class="btn btn-primary">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('categories-depenses.index') }}" class="row g-2">
                <div class="col-md-4">
                ...
                <tbody>
                    @forelse ($categories as $categorie)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('categories-depenses.show', $categorie) }}">
                                    {{ $categorie->nom }}
                                </a>
                            </td>
                            ...
                            <td class="text-end">
                                <a href="{{ route('categories-depenses.edit', $categorie) }}"
                                   class="btn btn-sm btn-outline-primary" title="Modifier">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="{{ route('categories-depenses.destroy', $categorie) }}"
