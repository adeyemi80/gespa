                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}"
                               class="form-control form-control-lg rounded-3 shadow-sm" required autofocus autocomplete="name">
                    </div>
                    ...
                    <div class="form-check my-3">
                        ...
                        <label for="terms" class="form-check-label small text-muted">
                            {!! __('J’accepte les :terms_of_service et la :privacy_policy', [
                                'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="text-primary text-decoration-none fw-semibold">'.__('Conditions d’utilisation').'</a>',
                                'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="text-primary text-decoration-none fw-semibold">'.__('Politique de confidentialité').'</a>',
                            ]) !!}
                        </label>
                    </div>
                @endif
