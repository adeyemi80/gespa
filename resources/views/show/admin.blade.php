...
<div class="container py-5">
    ...
    <h3 class="mb-0">🗂️ Rôle de la Secrétaire</h3>
    ...
    <a href="{{ route('roles.pdf', 'secretaire') }}" class="btn btn-light btn-sm">
        ...
        <div class="card-body fs-4">
            ...
            {{-- Introduction --}}
            <p>
                La secrétaire joue un rôle clé dans le fonctionnement administratif de l’établissement.
                Elle assure la gestion des documents, l’accueil et la communication interne et externe.
            </p>
            ...
            {{-- 3. Suivi des élèves --}}
            <div class="mb-4">
                <h5 class="text-info fw-bold">📚 3. Suivi des dossiers scolaires</h5>
                <ul>
            ...
            {{-- 4. Communication --}}
            <div class="mb-4">
                <h5 class="text-info fw-bold">📞 4. Communication</h5>
                <ul>
            ...
            <div class="mb-4">
                <h5 class="text-info fw-bold">🤝 5. Appui à la direction</h5>
                <ul>
            ...
            {{-- 6. Organisation --}}
            <div class="mb-4">
                <h5 class="text-info fw-bold">📅 6. Organisation</h5>
                <ul>
    ...
    <a href="{{ route('roles.pdf', 'comptable') }}" class="btn btn-dark btn-sm">
        ...
        <div class="card-body fs-4">
            ...
            <div class="mb-4">
                <h5 class="text-warning fw-bold">💸 2. Gestion des dépenses</h5>
                <ul>
            ...
            <div class="mb-4">
                <h5 class="text-warning fw-bold">📊 3. Tenue de la comptabilité</h5>
                <ul>
            ...
            {{-- 4. Gestion du budget --}}
            <div class="mb-4">
                <h5 class="text-warning fw-bold">📈 4. Gestion budgétaire</h5>
                <ul>
            ...
            {{-- 5. Collaboration --}}
            <div class="mb-4">
                <h5 class="text-warning fw-bold">🤝 5. Collaboration avec la direction</h5>
                <ul>
    ...
    <a href="{{ route('roles.pdf', 'parent') }}" class="btn btn-light btn-sm">
        ...
        <div class="card-body fs-4">
            ...
            <div class="mb-4">
                ...
                <ul>
                    <li>Participer aux réunions parents-enseignants</li>
