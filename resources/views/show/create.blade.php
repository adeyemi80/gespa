...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards1 = [
                    ['route'=>'finances.index','color'=>'primary','icon'=>'people-fill','title'=>'Finances & Gestion '],
                    ['route'=>'parens.import.form','color'=>'warning','icon'=>'person-lines-fill','title'=>'Importer les parents'],
                    ['route'=>'matieres.import','color'=>'danger','icon'=>'journal-text','title'=>'Importer les matières'],
                    ['route'=>'notes.import-livewire','color'=>'success','icon'=>'clipboard-check','title'=>'Importer des notes'],
                ];
            @endphp
