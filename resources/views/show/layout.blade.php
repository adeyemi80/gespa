...
{{-- SIDEBAR FIXE --}}
<div class="sidebar">
    <h6 class="text-center mb-4">📚 ADMINISTRATEUR – CPEG LE GLORIEUX</h6>

    <ul class="nav nav-pills flex-column gap-1">
        <li><a href="/show/admin" class="nav-link text-white">📊 Année Scolaire & Classes</a></li>
        ...
        <li><a href="/register" class="nav-link text-white">ENREGISTREMENT DES UTILISATEURS</a></li>
    </ul>
</div>
