...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        <h6 class="section-title">📥 Importations </h6>
        <div class="row g-3 mb-4">

            @php
                $cards1 = [
                    ['route'=>'eleves.import','color'=>'info','icon'=>'people-fill','title'=>'IMPORTATION DES ELEVES '],
                    ['route'=>'parens.import.form','color'=>'info','icon'=>'person-lines-fill','title'=>'IMPORTATION DES PARENTS'],
                    ['route'=>'notes.import-livewire','color'=>'info','icon'=>'journal-text','title'=>'IMPORTATION DES NOTES'],
                    ['route'=>'eleves.photos','color'=>'info','icon'=>'journal-bookmark-fill','title'=>'IMPORTATION DES PHOTOS'],
                ];
            @endphp
...
<div class="row g-3 mb-4">
            ...
            @php
                $cards1 = [
                    ['route'=>'conduites.import','color'=>'info','icon'=>'people-fill','title'=>'IMPORTATION DES CONDUITES '],
                    ['route'=>'tests.importForm','color'=>'info','icon'=>'person-lines-fill','title'=>'IMPORTATION DES EPREUVES'],
                    ['route'=>'enseignants.import','color'=>'info','icon'=>'journal-text','title'=>'IMPORTATION DES ENSEIGNANTS '],
                     ['route'=>'matieres.import','color'=>'info','icon'=>'journal-text','title'=>'IMPORTATION DES MATIERES '],
