...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards1 = [
                    ['route'=>'annees.create','color'=>'primary','icon'=>'people-fill','title'=>'Créer une Année Scolaire '],
                    ['route'=>'trimestres.create','color'=>'primary','icon'=>'person-lines-fill','title'=>'Création des Trimsetres'],
                    ['route'=>'classes.create','color'=>'primary','icon'=>'journal-text','title'=>'Créer une Classe'],
                    ['route'=>'matieres.create','color'=>'primary','icon'=>'clipboard-check','title'=>'Créer une Matière'],
                ];
            @endphp
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards2 = [
                    ['route'=>'annees.index','color'=>'info','icon'=>'journal-bookmark-fill','title'=>'Les Années Scolaires'],
                    ...
                    ['route'=>'matieres.index','color'=>'info','icon'=>'files','title'=>'Les Matières'],
                ];
            @endphp
        ...
        <div class="row g-3 mb-3">
            ...
            @php
                $cards3 = [
                    ['route'=>'paiements.paiement','color'=>'success','icon'=>'wallet2','title'=>' PAIEMENTS'],
                     ['route'=>'paiements.create-up','color'=>'success','icon'=>'wallet2','title'=>'LES PAIEMENTS'],
                    ['route'=>'depenses.create','color'=>'danger','icon'=>'cash-stack','title'=>'ENREGISTRER DEPENSES'],
                    ['route'=>'budgets.create','color'=>'secondary','icon'=>'pie-chart-fill','title'=>'CREER LE BUDGET'],
