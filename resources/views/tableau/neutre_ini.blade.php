...
@media (max-width: 576px) {
    .marquee-glass strong { font-size: 0.85rem; }
        ...
        header {
            margin-bottom: 0; /* supprime la marge sous le header */
            padding-bottom: 0; /* supprime padding si présent */
        }

        .sidebar {
            margin-top: 0; /* supprime la marge au dessus de la sidebar */
            padding-top: 0; /* supprime padding si présent */
        }

        /* Pour être sûr */
        body, .container, .dashboard-scroll {
            margin: 0;
            padding: 0;
        }
.marquee-content {
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center h-100 px-5">
        ...
        <div class="d-flex align-items-center gap-4">
            <a class="header-btn glass-effect text-light" href="" title="">
                ...
                <span class="d-none d-xl-inline ms-2 fw-semibold"> +229 01 97 52 16 37 <br> +229 01 97 18 93 24</span>
            </a>
           <!-- <a class="header-btn glass-effect text-light" href="mailto:complexeleglorieux@gmail.com" title="Email">
                <i class="fas fa-envelope fs-4"></i>
                <span class="d-none d-xl-inline ms-2 fw-semibold">collegeleglorieux@gmail.com</span>
            </a>-->
...
<div class="dropdown">
    ...
    <button 
        class="header-btn glass-effect d-flex align-items-center gap-3 p-3 text-light border-0 bg-transparent"
        type="button"
...
@auth
    ...
    @if ($user->role === 'censeur')
        @include('components.sidebar.sidebar-censeur')
    @elseif ($user->role === 'admin')
        @include('components.sidebar.sidebar-admin')
    @elseif ($user->role === 'parent')
        @include('components.sidebar.sidebar-parent')
    @elseif ($user->role === 'secretaire')
        @include('components.sidebar.sidebar-secretaire')
    @elseif ($user->role === 'directeur')
        @include('components.sidebar.sidebar-directeur')
    @elseif ($user->role === 'comptable')
        @include('components.sidebar.sidebar-comptable')
    @elseif ($user->role === 'surveillant')
        @include('components.sidebar.sidebar-surveillant')
    @elseif ($user->role === 'enseignant')
        @include('components.sidebar.sidebar-enseignant')
    @else
        {{-- sidebar par défaut (si tu veux) --}}
    @endif
@endauth
...
.particle {
    ...
    document.addEventListener('click', async function (e) {
        ...
        // Ignorer les liens vides, ancres, ou liens externes
        if (!link) return;
