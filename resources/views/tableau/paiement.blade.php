...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        {{-- 🟦 GROUPE 1 : LES PAIEMENTS--}}
        <h6 class="section-title">PAIEMENTS</h6>
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards2 = [
                    ['route'=>'frais.create','color'=>'info','icon'=>'journal-bookmark-fill','title'=>'CREER UN FRAIS'],
                    ['route'=>'frais.index','color'=>'info','icon'=>'file-earmark-arrow-up','title'=>'Les FRAIS'],
                    ['route'=>'inscription-frais.index','color'=>'info','icon'=>'file-text','title'=>'LES FRAIS PAR ELEVE'],
                    ['route'=>'frais.annee_classe.index','color'=>'info','icon'=>'files','title'=>'MODIFIER LES FRAIS'],
                ];
            @endphp
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards2 = [
                    ['route'=>'td.dirige','color'=>'primary','icon'=>'journal-bookmark-fill','title'=>'Travaux dirigés'],
