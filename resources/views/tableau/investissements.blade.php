...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        {{-- 🟦 GROUPE 1 : INVESTISSEMENTS--}}
        <h6 class="section-title">📥 INVESTISSEMENTS</h6>
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards3 = [
                    ['route'=>'rapports.index','color'=>'info','icon'=>'cash-stack','title'=>'RAPPORTS INVESTISSEMENT'],
                    ['route'=>'versements.create','color'=>'success','icon'=>'file-earmark-arrow-up','title'=>'ENREGISTRER VERSEMENT CAPITAL'],
                    ['route'=>'versements.index','color'=>'info','icon'=>'file-text','title'=>'LES VERSEMENTS'],
                    ['route'=>'repartitions.index','color'=>'warning','icon'=>'files','title'=>'LES REPARTITIONS'],
                ];
            @endphp
        ...
        <div class="row g-3 mb-3">
            ...
            @php
                $cards4 = [
                    ['route'=>'parametres.index','color'=>'success','icon'=>'wallet2','title'=>'LES PARAMETRES'],
                    ['route'=>'oloyes.create','color'=>'success','icon'=>'wallet2','title'=>'ENREGISTRER DEPENSES OLOYE'],
                    ['route'=>'oloyes.index','color'=>'success','icon'=>'wallet2','title'=>'LES DEPENSES OLOYE'],
