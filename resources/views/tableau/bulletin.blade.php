...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        {{-- 🟦 GROUPE 1 : BULLETINS--}}
        <h6 class="section-title">📥 LES RESULTATS</h6>
        ...
        <div class="row g-3 mb-4">
         ...
         {{-- 🟩 GROUPE 2 : PASSAGE --}}
        <h6 class="section-title">📘 PASSAGE</h6>
        <div class="row g-3 mb-4">

            @php
                $cards2 = [
                    ['route'=>'passages.index','color'=>'info','icon'=>'journal-bookmark-fill','title'=>'PASSAGE SCOLAIRE'],
                    ['route'=>'passages.annuler','color'=>'info','icon'=>'journal-bookmark-fill','title'=>'ANNULATION PASSAGE'],
                    ['route'=>'fiches.formulaire','color'=>'info','icon'=>'file-text','title'=>'FICHE PAR MATIERE'],
                    ['route'=>'fiches.index','color'=>'info','icon'=>'files','title'=>'FICHES PAR CLASSE'],
                ];
            @endphp
