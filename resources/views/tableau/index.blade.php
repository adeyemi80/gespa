...
@section('title', 'Surveillance Générale')
...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards1 = [
                    ['route'=>'conduites.import','color'=>'primary','icon'=>'people-fill','title'=>'Importer les Conduites'],
                    ['route'=>'conduites.create','color'=>'warning','icon'=>'person-lines-fill','title'=>'Créer une Conduite'],
                    ['route'=>'conduites.index','color'=>'danger','icon'=>'journal-text','title'=>'Les Conduites'],
