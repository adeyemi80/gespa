...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        {{-- 🟦 GROUPE 1 : EXAMENS BLANCS--}}
        <h6 class="section-title">📥 GESTION DES EXAMENS BLANCS</h6>
        <div class="row g-3 mb-4">

            @php
                $cards2 = [
                    ['route'=>'examens-blancs.create','color'=>'primary','icon'=>'journal-bookmark-fill','title'=>'CREER UN EXAMEN BLANC'],
                    ['route'=>'examens-blancs.index','color'=>'primary','icon'=>'file-earmark-arrow-up','title'=>' LES EXAMENS BLANCS'],
                    ['route'=>'examens.notes.index','color'=>'primary','icon'=>'file-text','title'=>'LES NOTES DES EXAMENS'],
                ];
            @endphp
