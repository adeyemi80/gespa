...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        {{-- 🟦 GROUPE 1 : CONDUITES--}}
        <h6 class="section-title">📥 LES CONDUITES</h6>
        <div class="row g-3 mb-4">

            @php
                $cards1 = [
                    ['route'=>'conduites.create','color'=>'primary','icon'=>'people-fill','title'=>'Créer une Conduite '],
                    ['route'=>'conduites.import','color'=>'primary','icon'=>'person-lines-fill','title'=>'Importation des Conduites'],
                    ['route'=>'conduites.index','color'=>'primary','icon'=>'journal-text','title'=>'Les Conduites'],
