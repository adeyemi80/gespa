...
<div class="container-fluid py-3 h-100">
    <div class="dashboard-scroll">
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards1 = [
                    ...
                    ['route'=>'finances.index','color'=>'primary','icon'=>'clipboard-check','title'=>'FINANCES'],
                    ['route'=>'recettes.index','color'=>'primary','icon'=>'clipboard-check','title'=>'RECETTES'],
                ];
            @endphp
        ...
        <div class="row g-3 mb-4">
            ...
            @php
                $cards2 = [
                    ['route'=>'depenses.index','color'=>'primary','icon'=>'clipboard-check','title'=>'DEPENSES'],
                ];
            @endphp
